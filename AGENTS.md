...
state/               runtime records and signals; gitignored
  ...
  <id>.dispatch-choice.json <id>.dispatch-runtime.json  opt-in task/model preset sample and observed runtime settings; removed after the durable comparison event is finalized
